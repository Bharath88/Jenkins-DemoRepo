...
/*
**  pIM_SRVC_FLOW_Complete
*/

//{{FORM_CLASS_DECL
public class pIM_SRVC_FLOW_Complete extends pIM_SRVC_FLOW_CompleteBase
...
//{{FORM_CLASS_CTOR
public pIM_SRVC_FLOW_Complete ( PLSApp parentApp ) throws VSException, java.beans.PropertyVetoException {
	super(parentApp);
//END_FORM_CLASS_CTOR}}
   }
...
void T1IM_SRVC_FLOW_beforeQuery(VSQuery foQuery, VSOutParam loResultSet)
{
   ...
   // Sort by Sequence Number in descending order when page is opened.
   if (mboolFirstLoad)
   {
      loSearchRequest = new SearchRequest();
      loSearchRequest.add("RUN_END_TS DESC");
...
//{{EVENT_pIM_SRVC_FLOW_Complete_beforeActionPerformed
void pIM_SRVC_FLOW_Complete_beforeActionPerformed( ActionElement ae, PageEvent evt, PLSRequest preq )
{
   ...
   if (AMSStringUtil.strEqual(lsName, "btnT2pIM_SRVC_LVL_LOG_Grid"))
   {
...
//END_EVENT_pIM_SRVC_FLOW_Complete_beforeActionPerformed}}
...
//{{EVENT_ADAPTER_CODE
	...
	public void beforeActionPerformed ( VSPage obj, ActionElement ae, PageEvent evt, PLSRequest preq){
		Object source = obj;
		if (source == this ) {
			pIM_SRVC_FLOW_Complete_beforeActionPerformed( ae, evt, preq );
		}
	}
