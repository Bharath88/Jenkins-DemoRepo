...
/*
**  pIM_SRVC_FLOW_Active
*/

//{{FORM_CLASS_DECL
public class pIM_SRVC_FLOW_Active extends pIM_SRVC_FLOW_ActiveBase
...
//{{FORM_CLASS_CTOR
public pIM_SRVC_FLOW_Active ( PLSApp parentApp ) throws VSException, java.beans.PropertyVetoException {
	super(parentApp);
//END_FORM_CLASS_CTOR}}
   }
...
//{{EVENT_pIM_SRVC_FLOW_Active_beforeActionPerformed
void pIM_SRVC_FLOW_Active_beforeActionPerformed( ActionElement ae, PageEvent evt, PLSRequest preq )
{
...
//END_EVENT_pIM_SRVC_FLOW_Active_beforeActionPerformed}}
...
//{{EVENT_ADAPTER_CODE
	...
	public void beforeActionPerformed ( VSPage obj, ActionElement ae, PageEvent evt, PLSRequest preq){
		Object source = obj;
		if (source == this ) {
			pIM_SRVC_FLOW_Active_beforeActionPerformed( ae, evt, preq );
		}
	}
