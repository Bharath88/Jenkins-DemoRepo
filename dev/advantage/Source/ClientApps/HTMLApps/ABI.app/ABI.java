...
//{{APP_CLASS_DECL
public class ABI extends ABIBase
//END_APP_CLASS_DECL}}
{
    // ABI Class Constructor
	//{{APP_CLASS_CTOR
	public ABI ()
	//END_APP_CLASS_CTOR}}
    {
		...
		//{{APP_DOACTION
		   ...
		   if ( VSTrace.IS_ON ){
		   	tr = VSTrace.get();	
		     	...
		     	tr.set(VST_SESSION_ID, getSessionIDForTracing()).set(VST_CATEGORY, VST_PLS_ACTION).set(VST_ACTION_NAME,"ABI.doAction");
		}
