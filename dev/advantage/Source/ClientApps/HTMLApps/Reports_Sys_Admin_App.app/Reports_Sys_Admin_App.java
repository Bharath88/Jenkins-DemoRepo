...
//END_APP_IMPORT_STMTS}}
	...
	//{{APP_CLASS_DECL
	public class Reports_Sys_Admin_App extends Reports_Sys_Admin_AppBase
	//END_APP_CLASS_DECL}}
	
	{
	    // Reports_Sys_Admin_App Class Constructor
		//{{APP_CLASS_CTOR
		public Reports_Sys_Admin_App ()
		//END_APP_CLASS_CTOR}}
	    {
		    super();
	    }
			...
			//{{APP_DOACTION
			   ...
			   if ( VSTrace.IS_ON ){
			   	tr = VSTrace.get();	
			     	...
			     	tr.set(VST_SESSION_ID, getSessionIDForTracing()).set(VST_CATEGORY, VST_PLS_ACTION).set(VST_ACTION_NAME,"Reports_Sys_Admin_App.doAction");
			}
