...
//{{FORM_CLASS_DECL
public class View_Chain_Job_List extends View_Chain_Job_ListBase
      ...
      implements AMSBatchConstants
{
   ...
   private static Log moAMSLog = AMSLogger.getLog( View_Chain_Job_List.class,
...
//{{FORM_CLASS_CTOR
public View_Chain_Job_List ( PLSApp parentApp ) throws VSException, java.beans.PropertyVetoException {
	super(parentApp);
//END_FORM_CLASS_CTOR}}
   }

//{{EVENT_CODE
//{{EVENT_View_Chain_Job_List_requestReceived
   void View_Chain_Job_List_requestReceived(PLSRequest req, PageEvent evt)
   {
...
//END_EVENT_View_Chain_Job_List_requestReceived}}
//{{EVENT_View_Chain_Job_List_beforeActionPerformed
void View_Chain_Job_List_beforeActionPerformed( ActionElement ae, PageEvent evt, PLSRequest preq )
{
...
//END_EVENT_View_Chain_Job_List_beforeActionPerformed}}
...
//{{EVENT_ADAPTER_CODE
	...
	public void requestReceived ( VSPage obj, PLSRequest req, PageEvent evt ){
		Object source = obj;
		if (source == this ) {
			View_Chain_Job_List_requestReceived( req, evt );
		}
	}
	public void beforeActionPerformed ( VSPage obj, ActionElement ae, PageEvent evt, PLSRequest preq){
		Object source = obj;
		if (source == this ) {
			View_Chain_Job_List_beforeActionPerformed( ae, evt, preq );
		}
	}
