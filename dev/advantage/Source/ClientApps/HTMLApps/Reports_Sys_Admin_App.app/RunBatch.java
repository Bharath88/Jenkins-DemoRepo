...
import java.rmi.RemoteException;
	...
	//{{FORM_CLASS_DECL
	public class RunBatch extends RunBatchBase
...

	{
	   ...
	   private static Log moAMSLog = AMSLogger.getLog( RunBatch.class,
	      AMSLogConstants.FUNC_AREA_DFLT ) ;


	//{{FORM_CLASS_CTOR
	public RunBatch ( PLSApp parentApp ) throws VSException, java.beans.PropertyVetoException {
		super(parentApp);
	//END_FORM_CLASS_CTOR}}
	   }
	//{{EVENT_CODE
	...
	//END_EVENT_ADAPTER_CODE}}
	   ...
	   /**
	    * This method add an onLoad script to navigate to report tree page
	    *
	   ...
	   public String generate()
	   {
	      try
	      {
	         getParentApp().getSession().getORBSession().setProperty(
	               RSAA_ROLE, AMSReportTreeNode.MODE_NAVIGATE ) ;
	         if ( moTreeTran == null )
	         {
