...
/*
**  pR_SC_USER_QRY_Search
*/

//{{FORM_CLASS_DECL
public class pR_SC_USER_QRY_Search extends pR_SC_USER_QRY_SearchBase
...
//END_FORM_CLASS_DECL}}
{
	...
	//{{FORM_CLASS_CTOR
	public pR_SC_USER_QRY_Search ( PLSApp parentApp ) throws VSException, java.beans.PropertyVetoException {
		super(parentApp);
	//END_FORM_CLASS_CTOR}}
	}
	...
	//public void beforeGenerate(VSPage p, HTMLDocumentModel docModel, 
