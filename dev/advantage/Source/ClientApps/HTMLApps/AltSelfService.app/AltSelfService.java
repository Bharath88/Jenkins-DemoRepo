...
//{{APP_CLASS_DECL
public class AltSelfService extends AltSelfServiceBase
//END_APP_CLASS_DECL}}
{
    // AltSelfService Class Constructor
	//{{APP_CLASS_CTOR
	public AltSelfService ()
	//END_APP_CLASS_CTOR}}
    {
	    super();
    }
		...
		//{{APP_DOACTION
		   ...
		   if ( VSTrace.IS_ON ){
		   	tr = VSTrace.get();	
		     	...
		     	tr.set(VST_SESSION_ID, getSessionIDForTracing()).set(VST_CATEGORY, VST_PLS_ACTION).set(VST_ACTION_NAME,"AltSelfService.doAction");
		}
