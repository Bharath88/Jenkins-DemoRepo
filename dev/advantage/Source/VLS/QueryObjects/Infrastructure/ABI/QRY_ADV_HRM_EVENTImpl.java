...
public class QRY_ADV_HRM_EVENTImpl extends  QRY_ADV_HRM_EVENTBaseImpl
...
//END_COMPONENT_RULES_CLASS_DECL}}
{
   ...
   {
      BusinessObjectImpl loAdvHrmQuery = foRowToBeAdded.getBusinessObject();
      Session loSession = loAdvHrmQuery.getSession();
      /*
            ...
            && ( ( foRowToBeAdded.getData( "SOURCE_EVENT_ID" ).getString() == null ) ) )
      {
         ...
         loSearchRequest.addParameter( "ADV_HRM_EVENT", "SOURCE_EVENT_ID", ""
               + liEventId );
         int liRprcCnt = ADV_HRM_EVENTImpl.getObjectCount( loSearchRequest,
               loSession );
         foRowToBeAdded.getData( "RPRC_CNT" ).setint( liRprcCnt );
         loSearchRequest = new SearchRequest();
         loSearchRequest.addParameter( "ADV_HRM_EVENT", "SOURCE_EVENT_ID", ""
               + liEventId );
         loSearchRequest.addParameter( "ADV_HRM_EVENT", "EVENT_STATUS", "S" );
         int liRprcSuccsCnt = ADV_HRM_EVENTImpl.getObjectCount(
