...
/*
**  QRY_ADV_PERMITTING_EVENT
*/

//{{COMPONENT_RULES_CLASS_DECL
public class QRY_ADV_PERMITTING_EVENTImpl extends  QRY_ADV_PERMITTING_EVENTBaseImpl
...
//END_COMPONENT_RULES_CLASS_DECL}}
{
   ...
   {
      BusinessObjectImpl loAdvPermQuery = foRowToBeAdded.getBusinessObject();
      Session loSession = loAdvPermQuery.getSession();
      /*
            ...
            && ( ( foRowToBeAdded.getData( "SOURCE_TRANSACT_ID" ).getString() == null ) ) )
      {
         ...
         loSearchRequest.addParameter( "ADV_PERMITTING_EVENT", "SOURCE_TRANSACT_ID", ""
               + liEventId );
         int liRprcCnt = ADV_PERMITTING_EVENTImpl.getObjectCount( loSearchRequest,
               loSession );
         ...
         loSearchRequest.addParameter( "ADV_PERMITTING_EVENT", "SOURCE_TRANSACT_ID", ""
               + liEventId );
         loSearchRequest.addParameter( "ADV_PERMITTING_EVENT", "EVENT_STATUS", "S" );
         int liRprcSuccsCnt = ADV_PERMITTING_EVENTImpl.getObjectCount(
